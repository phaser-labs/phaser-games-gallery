...
export class LoadMedia_v3 extends Phaser.Scene {
  ...
  create() {
    ...
    this.load.tilemapTiledJSON('mesaBillar_v3', 'assets/maps/mesaPool3Corta.tmj');
    this.load.image('mesa_v3', 'assets/tilesets/mesa3.png');
    ...
    this.load.image('cue', 'assets/images/cue/poolCue_3.png');
