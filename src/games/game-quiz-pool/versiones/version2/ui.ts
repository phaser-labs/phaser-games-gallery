    ...
    <aside class=${css.aside}>
      ...
      <div class=${css.secondSection}>
        ...
        <div class=${css.cotainerMuteButton}>
          <button data-mute style="pointer-events:auto" class="flex items-center justify-center size-15 rounded-lg   bg-slate-800 hover:bg-slate-700 transition-colors  text-slate-300">
            <span data-mute-on>
