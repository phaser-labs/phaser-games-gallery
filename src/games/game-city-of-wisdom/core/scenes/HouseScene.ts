...
export class HouseScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add.text(600, -100, 'House', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(310, 280, 'house');
    video.setDisplaySize(630, 525); // Ocupar todo el canvas
    video.setOrigin(0.5);
