...
export class ShoolScene extends Phaser.Scene {
  constructor() {
    super('ShoolScene');
  }
  preload() {}
  create() {
    ...
    // create
    const title = this.add.text(600, -100, 'school', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(400, 260, 'school');

    video.setDisplaySize(186, 183); // Ocupar todo el canvas
    video.setOrigin(0.5);
