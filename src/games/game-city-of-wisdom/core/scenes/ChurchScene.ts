...
export class ChurchScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add.text(600, -100, 'Church', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(310, 280, 'church');
