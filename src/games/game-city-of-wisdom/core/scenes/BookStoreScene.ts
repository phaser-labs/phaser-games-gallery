...
export class BookStoreScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add.text(600, -100, 'Book Store', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(310, 280, 'booksStore');
