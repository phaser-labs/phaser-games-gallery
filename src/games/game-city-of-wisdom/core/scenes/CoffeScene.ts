...
export class CoffeScene extends Phaser.Scene {
  constructor() {
    super('CoffeScene');
  }
  preload() {}
  create() {
    ...
    const title = this.add.text(600, -100, 'Coffe Shop', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(500, 280, 'coffeShop');

    video.setDisplaySize(500, 530); // Ocupar todo el canvas
    video.setOrigin(0.5);
