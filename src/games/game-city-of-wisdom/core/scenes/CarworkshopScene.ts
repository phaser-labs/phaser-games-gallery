...
export class CarworkshopScene extends Phaser.Scene {
  constructor() {
    super('CarworkshopScene');
  }
  preload() {}
  ...
  create() {
    ...
    const title = this.add.text(600, -100, 'Car workshop', {
      fontFamily: 'pixel',
      fontSize: '48px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const video = this.add.video(310, 280, 'carworkshop');
