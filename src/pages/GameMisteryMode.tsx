      ...
      <div className={'container'} style={{ gridTemplateColumns: '1fr' }}>
        <Row justifyContent="center" alignItems="center">
          <div style={{ width: '60%', margin: '0 auto' }} className="u-flow">
            ...
            <p>
              <strong>Game Mistery Mode</strong> es un juego de deducción donde los jugadores se convierten en
              detectives para resolver casos descubriendo personajes misteriosos. Cada caso presenta pistas ocultas que
              deberás revelar estratégicamente para identificar la respuesta correcta antes de quedarte sin
              oportunidades.
            </p>
            ...
            <ul className="u-flow list_star">
              <li>
                <p>
                  <strong>Sistema de pistas progresivas:</strong> Cada caso contiene 5 pistas que se revelan una por
                  una, desde las más generales hasta las más específicas, ayudándote a deducir la respuesta.
                </p>
              </li>
              <li>
                <p>
                  <strong>Puntuación basada en estrategia:</strong> A menos pistas utilizadas, más puntos obtienes.
                  Desde 20 puntos usando solo 1 pista, hasta 1 punto si necesitas las 5 pistas.
                </p>
              </li>
              <li>
                <p>
