    ...
    <>
      ...
      <div className={'container'} style={{ gridTemplateColumns: '1fr' }}>
        <div style={{ width: '60%', margin: '0 auto' }} className="u-flow">
          ...
          <p>
            Este es un juego en el que debes reorganizar palabras hasta formar correctamente diferentes frases. Su mejor
            característica es la posibilidad de elegir entre tres temas distintos, o incluso crear uno personalizado.
          </p>
          <p className="u-fs-300 u-font-bold">Características:</p>
          <ul className="u-flow list_star">
            <li>
              <p>
                <strong>Cantidad de frases:</strong> La cantidad que se desee, aunque se recomienda una cantidad entre 3
                y 5.
              </p>
            </li>
            <li>
